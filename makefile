...
OPTIM_FLAG = -O3 -DNDEBUG -I /net/malt/m/qbarbato/2A/tpc++/TER/Eigen/Eigen -std=c++11
# Options en mode debug - La variable est DEBUG est définie comme vraie
DEBUG_FLAG = -g -DDEBUG -I /net/malt/m/qbarbato/2A/tpc++/TER/Eigen/Eigen -std=c++11
...
SRC = main.cc OdeSystem.cpp TimeScheme.cpp
